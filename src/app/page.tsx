    ...
    <div className="min-h-screen flex flex-col justify-between overflow-x-hidden bg-background text-foreground transition-colors duration-300">
      ...
      <nav className="max-w-7xl w-full mx-auto px-6 py-5 flex items-center justify-between border-b border-border backdrop-blur-md sticky top-0 z-40 bg-background/80">
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 items-center justify-center rounded-[8px] bg-accent-tint dark:bg-gradient-to-br dark:from-[#10B981] dark:to-[#059669] shadow-sm dark:shadow-[0_0_15px_rgba(16,185,129,0.3)] animate-float">
            <Heart className="h-5 w-5 text-[#0F9D6C] dark:text-[#06110D] stroke-[2.5]" />
          </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-16 md:py-24 space-y-24 relative">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-8 relative">
          {/* Eyebrow Pill Badge */}
          <span className="inline-flex items-center gap-1.5 rounded-full bg-accent-tint px-3.5 py-1.5 text-[13px] font-semibold text-[#0F9D6C] dark:text-[#6EE7B7] border border-[rgba(15,157,108,0.3)] dark:border-[rgba(16,185,129,0.35)]">
          ...
          <h1 className="font-heading text-4xl md:text-[60px] font-black text-text-primary tracking-[-1.5px] leading-[1.1] max-w-4xl mx-auto">
            {content.headline}{' '}
            <span className="inline-flex items-center justify-center px-4 py-1 mx-1.5 rounded-[12px] bg-[#0F9D6C] text-[#FFFFFF] text-[24px] md:text-[44px] font-bold rotate-[-1.5deg] align-middle shadow-[0_4px_14px_rgba(15,157,108,0.25)]">
        ...
        <div className="relative max-w-4xl mx-auto mt-16 md:mt-24 h-[300px] md:h-[400px] w-full flex items-center justify-center">
          ...
          <div className="absolute left-2 md:left-12 top-4 md:top-12 z-20 bg-background border border-border p-4 md:p-6 rounded-2xl shadow-lg -rotate-[3deg] animate-float max-w-[160px] md:max-w-[200px]">
            ...
            <span className="block text-2xl md:text-4xl font-extrabold text-accent-amber mt-1">94%</span>
          ...
          <div className="w-[85%] md:w-[65%] h-[90%] bg-background border border-border rounded-2xl shadow-xl p-4 md:p-6 flex flex-col justify-between overflow-hidden relative">
            ...
            <div className="relative z-10 flex items-center justify-between border-b border-border pb-3.5">
              <div className="flex items-center gap-2">
                <span className="h-2.5 w-2.5 rounded-full bg-[#0F9D6C] animate-pulse" />
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-center py-6 space-y-4">
              <div className="h-1.5 w-full bg-border rounded-full relative overflow-hidden">
                <div className="absolute left-0 top-0 bottom-0 w-2/3 bg-[#0F9D6C] rounded-full" />
              </div>
              <div className="flex justify-between items-center text-xs text-text-secondary">
                ...
                <div className="flex items-center gap-1"><span className="animate-bounce">🚚</span> <span className="text-[10px] bg-accent-tint text-[#0F9D6C] px-1.5 py-0.5 rounded font-bold uppercase">Transit</span></div>
          ...
          <div className="absolute right-2 md:right-12 bottom-4 md:bottom-12 z-20 bg-background border border-border p-4 md:p-6 rounded-2xl shadow-lg rotate-[4deg] animate-float max-w-[160px] md:max-w-[200px]" style={{ animationDelay: '0.6s' }}>
            ...
            <span className="block text-2xl md:text-4xl font-extrabold text-[#0F9D6C] mt-1">2.5k</span>
        ...
        <div className="py-12 border-t border-border flex flex-col items-center justify-center space-y-6">
          <span className="text-[11px] font-bold text-text-tertiary uppercase tracking-wider">Trusted by 180+ partner organizations</span>
        ...
        <div className="border-t border-border pt-16 max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center flex flex-col justify-center items-center space-y-1">
            <span className="font-heading text-[32px] font-extrabold text-[#0F9D6C] dark:bg-gradient-to-r dark:from-[#10B981] dark:to-[#059669] dark:bg-clip-text dark:text-transparent inline-block leading-none">
              {stats.donations}
            </span>
        ...
        <div className="pt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
            ...
            {/* Step 1 */}
            <div className="bg-background border border-border rounded-2xl p-8 flex flex-col items-center text-center space-y-4 hover:shadow-[0_8px_24px_rgba(16,40,28,0.08)] hover:border-border-strong transition-all duration-300">
              <div className="h-16 w-16 rounded-[8px] bg-accent-tint flex items-center justify-center text-[#0F9D6C] dark:bg-gradient-to-br dark:from-[#10B981] dark:to-[#059669] dark:text-[#06110D] animate-float">
            ...
            {/* Step 2 */}
            <div className="bg-background border border-border rounded-2xl p-8 flex flex-col items-center text-center space-y-4 hover:shadow-[0_8px_24px_rgba(16,40,28,0.08)] hover:border-border-strong transition-all duration-300">
              <div className="h-16 w-16 rounded-[8px] bg-accent-tint flex items-center justify-center text-[#0F9D6C] dark:bg-gradient-to-br dark:from-[#10B981] dark:to-[#059669] dark:text-[#06110D] animate-float" style={{ animationDelay: '0.4s' }}>
            ...
            {/* Step 3 */}
            <div className="bg-background border border-border rounded-2xl p-8 flex flex-col items-center text-center space-y-4 hover:shadow-[0_8px_24px_rgba(16,40,28,0.08)] hover:border-border-strong transition-all duration-300">
              <div className="h-16 w-16 rounded-[8px] bg-accent-tint flex items-center justify-center text-[#0F9D6C] dark:bg-gradient-to-br dark:from-[#10B981] dark:to-[#059669] dark:text-[#06110D] animate-float" style={{ animationDelay: '0.8s' }}>
        ...
        <div className="bg-background border border-border-strong rounded-2xl p-8 flex flex-col md:flex-row md:items-center justify-between gap-8 mt-16 hover:shadow-[0_8px_24px_rgba(16,40,28,0.08)] hover:border-border-strong transition-all duration-300">
          <div className="space-y-3 max-w-lg">
            <span className="text-[10px] font-bold text-[#0F9D6C] dark:text-[#10B981] uppercase tracking-widest flex items-center gap-1">
